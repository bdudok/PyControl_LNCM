...
target_reached_trigger = Analog_trigger(
    threshold=v.reward_zone_list[0],
...
events = [
    ...
    'reward_timer', #internal timers
    # 'poll_timer', 'reward_timer',  # internal timers
    'reached_target', #rz entry trigger
    ...
    if not v.first_lap:
        ...
        for rz in v.reward_zone_list:
            if rz > v.pos:
                ...
                target_reached_trigger.set_threshold(v.next_reward)
                break
